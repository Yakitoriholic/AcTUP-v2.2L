function [out1,out2,out3] = GUI_ginput(arg1)
%This is a  version of the standard matlab ginput function which has been modified to 
%correct an annoying bug in Matlab 6.2 which causes the current figure to toggle each time the mouse button is pressed
%
...
%   $Revision: 5.30 $  $Date: 2001/04/15 12:03:29 $
